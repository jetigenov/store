# Generated by Django 3.1.5 on 2021-08-01 14:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='Slug')),
                ('price', models.DecimalField(blank=True, decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999.99'}}, help_text='Maximum 999.99', max_digits=5, null=True, verbose_name='Price')),
                ('discount_price', models.DecimalField(decimal_places=2, help_text='Maximum 999.99', max_digits=5, verbose_name='Discount Price')),
